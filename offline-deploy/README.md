...
- [MEF-Center离线安装场景](#mef-center离线安装场景)
  - [步骤1：配置安装节点信息](#步骤1配置安装节点信息)
  - [步骤2：导入MEF-Center软件包](#步骤2导入mef-center软件包)
  - [步骤3：安装MEF-Center](#步骤3安装mef-center)
  - [确认安装成功](#确认安装成功)
- [组件升级](#组件升级)
...
- 使用ssh免密的方式登录，配置方式可参考[常用操作5](#常用操作)。如果要安装驱动，请使用该方式。
...
第一行：SCENE_NUM 后填需要的[安装场景](#安装场景)，EXTRA后填希望的额外组件，如npu-exporter,noded,hccl-controller，MEF后填no（需要MEF的用户请看MEF-README）
