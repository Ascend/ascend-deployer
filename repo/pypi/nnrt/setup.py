...
url_map = {}
url_map['aarch64'] = "https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%206.0.RC1/Ascend-cann-nnrt_6.0.RC1_linux-aarch64.zip"

url_map['x86_64'] = "https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%206.0.RC1/Ascend-cann-nnrt_6.0.RC1_linux-x86_64.zip"
...
setuptools.setup(
    ...
    version='6.0.rc1',
    platforms=['Linux'],
    description=('ascend nnrt'),
    url = 'https://hiascend.com',
    long_description='ascend nnrt',
    classifiers = [
