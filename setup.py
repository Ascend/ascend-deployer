...
shutil.copyfile('README.rst', 'ascend_deployer/README.rst')
shutil.copyfile('README.en.rst', 'ascend_deployer/README.en.rst')
shutil.copyfile('start_download_ui.bat', 'ascend_deployer/start_download_ui.bat')
shutil.copyfile('start_download.bat', 'ascend_deployer/start_download.bat')
os.close(os.open('ascend_deployer/__init__.py', os.O_CREAT, 0o640))
