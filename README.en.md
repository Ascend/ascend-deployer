...
- CentOS 7.6 x86_ 64 as the system where the offline tool is located, you need to upgrade openssl-devel to version 1.1 or above, and ensure that this version of openssl-devel is used in operation.
